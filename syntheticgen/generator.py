...
class SyntheticDataGenerator:
    def __init__(self, config_file: str = 'config.yaml', base_path: str | None = None,  overrides: Optional[Dict]=None):
        ...
        if overrides:
            override_config = self._apply_overrides(self.config ,overrides)
    ...
    def _get_range_values(self, ent_, key, vals , ent_value):
        ...
        if min_v is None or max_v is None:
            ...
            print(f"Generating random min and max range value between (0,100) "
            ...
            for ent_key, ent_info in self.entity.items():
                ...
                for ent_value, ent_details in ent_info.items():
                    ...
                    if numeric_arrays:
                        ...
                        batch_records = [
                        {'timestamp': ts.isoformat(), **base_rec,
